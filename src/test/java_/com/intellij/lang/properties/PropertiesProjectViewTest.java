...
public abstract class PropertiesProjectViewTest extends LightPlatformCodeInsightFixtureTestCase {
  ...
  public void testBundle() {
    ...
    final consulo.ide.impl.idea.ide.projectView.impl.AbstractProjectViewPSIPane pane = setupPane(true);
  ...
  private consulo.ide.impl.idea.ide.projectView.impl.AbstractProjectViewPSIPane setupPane(final boolean sortByType) {
